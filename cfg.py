...
def dacregister(): # enter desired register values for initialization - these are twluke's
    bus.write_byte_data(0x48, 0x00, 0x00)  # clock gear MCLK=XIN
    ...
    bus.write_byte_data(0x48, 0x0b, 0x30) # using DATA3 for SPDIF input 00110000
    bus.write_byte_data(0x48, 0x0c, 0x00) # DPLL off 00000000
    bus.write_byte_data(0x48, 0x0d, 0x20) # jitter enable (default) 00100000
    bus.write_byte_data(0x48, 0x0e, 0x8a) # soft start (default) 10001010
    bus.write_byte_data(0x48, 0x0f, 0x0f) # stereo mode, ch1 mapped to DAC1
    ...
    bus.write_byte_data(0x48, 0x26, 0x10) # DAC 1-2 Mapping 
    bus.write_byte_data(0x48, 0x27, 0x32) # DAC 3-4 Mapping 
    bus.write_byte_data(0x48, 0x28, 0x54) # DAC 5-6 Mapping 
    bus.write_byte_data(0x48, 0x29, 0x76) # DAC 7-8 Mapping 
...
#        print (self.data) 
    ...
    def handle_command(self, line):
        ...
        if  line == 'spdif':
            bus.write_byte_data(0x48, 0x01, 0xe1)
